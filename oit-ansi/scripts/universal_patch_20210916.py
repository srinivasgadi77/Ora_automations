...
def patch_ol5():
       ...
       patch_cmd="https://pds-chef-dr-infrastructure.us.oracle.com/dis_chef_repo/security/ol5_cpu_patching.py"
       py_version='python'
...
def get_patch_script(os_type,os_version):
    ...
    if os_type == "DOMU":
       ...
       if os_version > 5:
           ...
           py_version='python'
           exe_cmd="/tmp/ol_cpu_patching.py  --quarterly --security-patch --force-fix"
